      ...
      <div className="space-y-10 relative">
        {filteredReleases.map((release, i) => (
          ...
          ><motion.a
                ...
                onMouseEnter={() => {
                  if (release.atmos) {
                    setAtmos(release.atmos);
                  }

                  hoverTimeout.current = window.setTimeout(() => {
                    playPreview(release.previewSong);
                  }, 300);
                }}
                onMouseLeave={() => {
                  setAtmos(null);
            ...
            >
              <div className="grid gap-6 p-6 md:grid-cols-[320px_1fr] md:gap-8 md:p-8">
                ...
                <div className="relative aspect-square overflow-hidden rounded-2xl">
                  ...
                  {/* Equalizer overlay */}
                  <div className="pointer-events-none absolute inset-x-0 bottom-0 flex h-16 items-end justify-center gap-1 px-6 pb-4 text-white opacity-0 transition-opacity duration-500 group-hover:opacity-90">
